...
function GetElements(){cboCategory=$("#cboCategory"),cboDifficulty=$("#cboDifficulty"),cboType=$("#cboType"),btnShoot=$("#btnShoot"),btnPrefs=$("#btnPrefs"),divPrefs=$(".preferences")}function SetupCategories(e){$.getJSON(e,function(e){ShowCategories(e)})}function ShowCategories(e){var o=e.trivia_categories;FillCategoriesComboBox(o=SortCategories(o))}function SortCategories(e){return e.sort(function(e,o){return e.name<o.name?1:e.name>o.name?-1:0}),e}function FillCategoriesComboBox(e){for(var o,t=e.length-1;t>=0;t--)void 0!==t&&(o+='<option value="'+e[t].id+'">'+e[t].name+"</option>");cboCategory.append(o)}function GetTriviaAPIUrl(e){var o=_GETQUESTION_LINK;for(var t in e)""!=e[t]&&(o+="&"+t+"="+e[t]);return o}function Shoot(){var e={category:cboCategory.val(),difficulty:cboDifficulty.val(),type:cboType.val()};console.log(GetTriviaAPIUrl(e))}function ShowPreferences(){"hidden"==divPrefs.css("visibility")?divPrefs.css("visibility","visible"):divPrefs.css("visibility","hidden")}var cboCategory,cboDifficulty,cboType,btnShoot,btnPrefs,divPrefs,_AMOUNT_QUESTIONS=1,_GETALLCATEGORIES_LINK="https://opentdb.com/api_category.php",_GETQUESTION_LINK="https://opentdb.com/api.php?amount="+_AMOUNT_QUESTIONS;document.addEventListener("DOMContentLoaded",function(){console.log("Ready!"),GetElements(),SetupCategories(_GETALLCATEGORIES_LINK),btnShoot.click(Shoot),btnPrefs.click(ShowPreferences)});