...
function GetElements(){cboCategory=$("#cboCategory"),cboDifficulty=$("#cboDifficulty"),cboType=$("#cboType"),btnShoot=$("#btnShoot"),btnPrefs=$("#btnPrefs"),headerSlogan=$(".header__slogan"),sectPrefs=$(".main__content__preferences"),sectQuestions=$(".main__content__question"),homepageContainer=$(".main__content__conainer"),answersContainer=$(".main__content__answers")}function SetupCategories(e){$.getJSON(e,function(e){ShowCategories(e)})}function ShowCategories(e){var n=e.trivia_categories;FillCategoriesComboBox(n=SortCategories(n))}function SortCategories(e){return e.sort(function(e,n){return e.name<n.name?1:e.name>n.name?-1:0}),e}function FillCategoriesComboBox(e){for(var n,o=e.length-1;o>=0;o--)void 0!==o&&(n+='<option value="'+e[o].id+'">'+e[o].name+"</option>");cboCategory.append(n)}function ShowPreferences(){boolShowPrefs?sectPrefs.css("display","none"):sectPrefs.css("display","flex"),boolShowPrefs=!boolShowPrefs}function Shoot(){GetQuestion(GetUrlQuestion({category:cboCategory.val(),difficulty:cboDifficulty.val(),type:cboType.val()}))}function GetUrlQuestion(e){var n=_GETQUESTION_LINK;for(var o in e)""!=e[o]&&(n+="&"+o+"="+e[o]);return console.log(n),n}function GetQuestion(e){$.getJSON(e,function(e){if(0!=e.response_code)return console.log("Error, try again"),null;changeDisplayProperty(homepageContainer,"none"),changeDisplayProperty(headerSlogan,"none"),changeDisplayProperty($(".main__content__answers"),"grid"),changeDisplayProperty($(".main__content__question"),"block"),showQuestion(e.results)})}function showQuestion(e){var n=e[0];if(sectQuestions.append('<div class="question__card"><p class="question__card__category">'+n.category+'</p><p class="question__card__question">'+n.question+"</p></div>"),"multiple"==n.type){var o=n.incorrect_answers;o.push(n.correct_answer),o.sort();for(var t=0;t<o.length;t++)createButtonAnswer(o[t],answersContainer)}else createButtonAnswer("True",answersContainer),createButtonAnswer("False",answersContainer);$(".btnAnswer").on("click",function(e){checkQuestion(e.target.innerHTML,n.correct_answer)})}function createButtonAnswer(e,n){n.append('<button class="btnAnswer">'+e+"</button>")}function checkQuestion(e,n){answersContainer.css("display","none"),sectQuestions.css("display","none"),e==n?(console.log("juist"),showCorrect()):(console.log("fout"),showIncorrect())}function hideQuestion(){answersContainer.css("display","none"),sectQuestions.css("display","none")}function showCorrect(){}function showIncorrect(){}function changeDisplayProperty(e,n){e.css("display",n)}var cboCategory,cboDifficulty,cboType,btnShoot,btnPrefs,headerSlogan,sectPrefs,sectQuestions,homepageContainer,answersContainer,boolShowPrefs,_AMOUNT_QUESTIONS=1,_GETALLCATEGORIES_LINK="https://opentdb.com/api_category.php",_GETQUESTION_LINK="https://opentdb.com/api.php?amount="+String(_AMOUNT_QUESTIONS);document.addEventListener("DOMContentLoaded",function(){console.log("Ready!"),GetElements(),SetupCategories(_GETALLCATEGORIES_LINK),btnShoot.click(Shoot),btnPrefs.click(ShowPreferences)});