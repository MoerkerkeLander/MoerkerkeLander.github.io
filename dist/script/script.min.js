...
function GetElements(){cboCategory=$("#cboCategory"),cboDifficulty=$("#cboDifficulty"),cboType=$("#cboType"),btnShoot=$("#btnShoot"),btnPrefs=$("#btnPrefs"),sectPrefs=$(".main__content__preferences"),sectQuestions=$(".main__content__question")}function SetupCategories(e){$.getJSON(e,function(e){ShowCategories(e)})}function ShowCategories(e){var t=e.trivia_categories;FillCategoriesComboBox(t=SortCategories(t))}function SortCategories(e){return e.sort(function(e,t){return e.name<t.name?1:e.name>t.name?-1:0}),e}function FillCategoriesComboBox(e){for(var t,o=e.length-1;o>=0;o--)void 0!==o&&(t+='<option value="'+e[o].id+'">'+e[o].name+"</option>");cboCategory.append(t)}function Shoot(){ShowQuestion(GetQuestion(GetUrlQuestion({category:cboCategory.val(),difficulty:cboDifficulty.val(),type:cboType.val()})))}function GetUrlQuestion(e){var t=_GETQUESTION_LINK;for(var o in e)""!=e[o]&&(t+="&"+o+"="+e[o]);return console.log(t),t}function GetQuestion(e){$.getJSON(e,function(e){return 0==e.response_code?e:(console.log("Error, try again"),null)})}function ShowQuestion(e){sectQuestions.append("<p>Test</p>")}function ShowPreferences(){"hidden"==sectPrefs.css("visibility")?sectPrefs.css("visibility","visible"):sectPrefs.css("visibility","hidden")}var cboCategory,cboDifficulty,cboType,btnShoot,btnPrefs,sectPrefs,sectQuestions,_AMOUNT_QUESTIONS=1,_GETALLCATEGORIES_LINK="https://opentdb.com/api_category.php",_GETQUESTION_LINK="https://opentdb.com/api.php?amount="+_AMOUNT_QUESTIONS;document.addEventListener("DOMContentLoaded",function(){console.log("Ready!"),GetElements(),SetupCategories(_GETALLCATEGORIES_LINK),btnShoot.click(Shoot),btnPrefs.click(ShowPreferences)});