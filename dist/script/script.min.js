...
function GetElements(){cboCategory=$("#cboCategory"),cboDifficulty=$("#cboDifficulty"),cboType=$("#cboType"),btnShoot=$("#btnShoot"),btnPrefs=$("#btnPrefs"),main__content=$(".main__content"),header__slogan=$(".header__slogan"),main__content__container=$(".main__content__container"),main__content__preferences=$(".main__content__preferences"),main__content__question=$(".main__content__question"),main__content__answers=$(".main__content__answers"),main__content__response=$(".main__content__response")}function SetupCategories(n){$.getJSON(n,function(n){ShowCategories(n)})}function ShowCategories(n){var e=n.trivia_categories;FillCategoriesComboBox(e=SortCategories(e))}function SortCategories(n){return n.sort(function(n,e){return n.name<e.name?1:n.name>e.name?-1:0}),n}function FillCategoriesComboBox(n){for(var e,t=n.length-1;t>=0;t--)void 0!==t&&(e+='<option value="'+n[t].id+'">'+n[t].name+"</option>");cboCategory.append(e)}function ShowPreferences(){boolShowPrefs?main__content__preferences.css("display","none"):main__content__preferences.css("display","flex"),boolShowPrefs=!boolShowPrefs}function Shoot(){GetQuestion(GetUrlQuestion({category:cboCategory.val(),difficulty:cboDifficulty.val(),type:cboType.val()}))}function GetUrlQuestion(n){var e=_GETQUESTION_LINK;for(var t in n)""!=n[t]&&(e+="&"+t+"="+n[t]);return console.log(e),e}function GetQuestion(n){$.getJSON(n,function(n){if(0!=n.response_code)return console.log("Error, try again"),null;hideOtherContainersButQuestion(),arrQuestions=n.results,console.log(arrQuestions),showQuestion(n.results)})}function hideOtherContainersButQuestion(){changeDisplayProperty(main__content__container,"none"),changeDisplayProperty(header__slogan,"none"),changeDisplayProperty($(".main__content__answers"),"grid"),changeDisplayProperty($(".main__content__question"),"block")}function showQuestion(n){var e=n[0];if(main__content__question.empty(),main__content__question.append('<div class="question__card"><p class="question__card__category">'+e.category+'</p><p class="question__card__question">'+e.question+"</p></div>"),main__content__answers.empty(),"multiple"==e.type){var t=e.incorrect_answers;t.push(e.correct_answer),t.sort();for(var o=0;o<t.length;o++)createButtonAnswer(t[o],main__content__answers)}else createButtonAnswer("True",main__content__answers),createButtonAnswer("False",main__content__answers);$(".btnAnswer").on("click",function(n){checkQuestion(n.target.innerHTML,e.correct_answer)})}function createButtonAnswer(n,e){e.append('<button class="btnAnswer">'+n+"</button>")}function checkQuestion(n,e){hideQuestion(),main__content__response.empty(),showCorrect(),$(".btnNewQuestion").click(newQuestion)}function hideQuestion(){main__content__answers.css("display","none"),main__content__question.css("display","none")}function newQuestion(){main__content.removeClass("correct incorrect"),changeDisplayProperty(main__content__response,"none"),Shoot()}function showCorrect(){main__content__response.css("display","grid"),main__content__response.append($('<?xml version="1.0" encoding="UTF-8"?><svg viewBox="0 0 148.11 119.31" xmlns="http://www.w3.org/2000/svg"><defs><style>.svgcolor{fill:#cecece;}</style></defs><g data-name="Layer 2"><g data-name="Eindwerk"><g data-name="QuestionSucces"><polygon class="svgcolor" points="125.98 0 50.94 75.05 22.12 46.24 0 68.36 28.81 97.17 28.8 97.18 50.92 119.31 148.11 22.12"/></g></g></g></svg>'),$("<p/>",{text:"Great, succes!"}),$("<button/>",{class:"btnNewQuestion",text:"New question!"})),main__content.addClass("correct")}function showIncorrect(){main__content__response.css("display","table"),main__content__response.append($('<?xml version="1.0" encoding="UTF-8"?><svg viewBox="0 0 119.7 120.7" xmlns="http://www.w3.org/2000/svg"><defs><style>.svgcolorIcc{fill:#aa1818;}</style></defs><title>Asset 10</title><g data-name="Layer 2"><g data-name="Eindwerk"><g data-name="QuestionSucces2"><polygon class="svgcolorIcc" points="119.7 23.13 97.57 1 60.35 38.22 22.13 0 0 22.13 38.22 60.35 0 98.57 22.13 120.7 60.35 82.48 97.57 119.7 119.7 97.57 82.48 60.35"/></g></g></g></svg>'),$("<p/>",{text:"Let‘s pretend that never happened!"}),$("<button/>",{class:"btnNewQuestion",text:"Try again!"})),main__content.addClass("incorrect")}function changeDisplayProperty(n,e){n.css("display",e)}var cboCategory,cboDifficulty,cboType,btnShoot,btnPrefs,main__content,header__slogan,main__content__preferences,main__content__question,main__content__container,main__content__answers,main__content__response,arrQuestions,boolShowPrefs,_AMOUNT_QUESTIONS=5,_GETALLCATEGORIES_LINK="https://opentdb.com/api_category.php",_GETQUESTION_LINK="https://opentdb.com/api.php?amount="+String(_AMOUNT_QUESTIONS);document.addEventListener("DOMContentLoaded",function(){console.log("Ready!"),GetElements(),SetupCategories(_GETALLCATEGORIES_LINK),btnShoot.click(Shoot),btnPrefs.click(ShowPreferences)});