...
function GetElements(){cboCategory=$("#cboCategory"),cboDifficulty=$("#cboDifficulty"),cboType=$("#cboType"),btnShoot=$("#btnShoot"),btnPrefs=$("#btnPrefs"),sectPrefs=$(".main__content__preferences"),sectQuestions=$(".main__content__question"),homepageContainer=$(".main__content__conainer"),answersContainer=$(".main__content__answers")}function SetupCategories(e){$.getJSON(e,function(e){ShowCategories(e)})}function ShowCategories(e){var o=e.trivia_categories;FillCategoriesComboBox(o=SortCategories(o))}function SortCategories(e){return e.sort(function(e,o){return e.name<o.name?1:e.name>o.name?-1:0}),e}function FillCategoriesComboBox(e){for(var o,n=e.length-1;n>=0;n--)void 0!==n&&(o+='<option value="'+e[n].id+'">'+e[n].name+"</option>");cboCategory.append(o)}function Shoot(){GetQuestion(GetUrlQuestion({category:cboCategory.val(),difficulty:cboDifficulty.val(),type:cboType.val()}))}function GetUrlQuestion(e){var o=_GETQUESTION_LINK;for(var n in e)""!=e[n]&&(o+="&"+n+"="+e[n]);return console.log(o),o}function GetQuestion(e){$.getJSON(e,function(e){if(0!=e.response_code)return console.log("Error, try again"),null;ShowQuestion(e.results)})}function ShowQuestion(e){homepageContainer.css("display","none"),$(".header__slogan").css("display","none"),$(".main__content__answers").css("display","grid"),$(".main__content__question").css("display","block");var o=e[0];if(sectQuestions.append('<div class="question__card"><p class="question__card__category">'+o.category+'</p><p class="question__card__question">'+o.question+"</p></div>"),"multiple"==o.type){(n=o.incorrect_answers).push(o.correct_answer);for(t=0;t<n.length;t++)answersContainer.append("<button>"+n[t]+"</button>")}else{var n=o.incorrect_answers;n.push(o.correct_answer);for(var t=0;t<n.length;t++)answersContainer.append("<button>"+n[t]+"</button>")}}function ShowPreferences(){boolShowPrefs?sectPrefs.css("display","none"):sectPrefs.css("display","flex"),boolShowPrefs=!boolShowPrefs}var cboCategory,cboDifficulty,cboType,btnShoot,btnPrefs,sectPrefs,sectQuestions,homepageContainer,answersContainer,boolShowPrefs,_AMOUNT_QUESTIONS=1,_GETALLCATEGORIES_LINK="https://opentdb.com/api_category.php",_GETQUESTION_LINK="https://opentdb.com/api.php?amount="+String(_AMOUNT_QUESTIONS);document.addEventListener("DOMContentLoaded",function(){console.log("Ready!"),GetElements(),SetupCategories(_GETALLCATEGORIES_LINK),btnShoot.click(Shoot),btnPrefs.click(ShowPreferences)});